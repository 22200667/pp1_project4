...
import com.example.pp1_project4.BoardVO;
import com.example.pp1_project4.JDBCUtil;
...
public class BoardDAO {
	...
	public int updateBoard(BoardVO vo) {
		...
		try {
			...
			stmt.setString(3, vo.getContent());
			stmt.setString(4, vo.getCategory());
			stmt.setTimestamp(5, vo.getEditdate());
			stmt.setInt(6	, vo.getSeq());
			
			
			System.out.println(vo.getTitle() + "-" + vo.getWriter() + "-" + vo.getContent() + "-" + vo.getCategory() +"-"+vo.getEditdate()+"-"+vo.getSeq());
			stmt.executeUpdate();
			return 1;
	...
	public BoardVO getBoard(int seq) {
		...
		try {
			...
			if(rs.next()) {
				...
				one.setEditdate(rs.getTimestamp("editdate"));//
